...
# ### 메뉴
    ...
    #     saverectAction.setDisabled(True)
    ...
    #     up_cam1_startAction.triggered.connect(self.start_up_cam1)

    #     up_cam1_stopAction = QAction('중지', self)
    #     up_cam1_stopAction.triggered.connect(self.stop_up_cam1)
    ...
    #     ### UP CAM2 메뉴
    #     up_cam2Menu = menubar.addMenu("UP CAM2")

    #     up_cam2_startAction = QAction('시작', self)
    #     up_cam2_startAction.triggered.connect(self.start_up_cam2)

    #     up_cam2_stopAction = QAction('중지', self)
    #     up_cam2_stopAction.triggered.connect(self.stop_up_cam2)

    #     up_cam2_poiAction = QAction('영역 설정', self)
    #     # up_cam2_poiAction.triggered.connect(self.show_rectPanel)
        
    #     up_cam2Menu.addAction(up_cam2_startAction)
    #     up_cam2Menu.addAction(up_cam2_stopAction)
    #     up_cam2Menu.addAction(up_cam2_poiAction)


    #     ### DN CAM1 메뉴
    #     dn_cam1Menu = menubar.addMenu("DN CAM1")

    #     dn_cam1_startAction = QAction('시작', self)
    #     dn_cam1_startAction.triggered.connect(self.start_dn_cam1)

    #     dn_cam1_stopAction = QAction('중지', self)
    #     dn_cam1_stopAction.triggered.connect(self.stop_dn_cam1)

    #     dn_cam1_poiAction = QAction('영역 설정', self)
    #     # dn_cam1_poiAction.triggered.connect(self.show_rectPanel)
        
    #     dn_cam1Menu.addAction(dn_cam1_startAction)
    #     dn_cam1Menu.addAction(dn_cam1_stopAction)
    #     dn_cam1Menu.addAction(dn_cam1_poiAction)

    #     ### DN CAM2 메뉴
    #     dn_cam2Menu = menubar.addMenu("DN CAM2")

    #     dn_cam2_startAction = QAction('시작', self)
    #     dn_cam2_startAction.triggered.connect(self.start_dn_cam2)

    #     dn_cam2_stopAction = QAction('중지', self)
    #     dn_cam2_stopAction.triggered.connect(self.stop_dn_cam2)

    #     dn_cam2_poiAction = QAction('영역 설정', self)
    #     # up_cam2_poiAction.triggered.connect(self.show_rectPanel)
        
    #     dn_cam2Menu.addAction(dn_cam2_startAction)
    #     dn_cam2Menu.addAction(dn_cam2_stopAction)
    #     dn_cam2Menu.addAction(dn_cam2_poiAction)
